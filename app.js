...
//   if(elem.pokemon.starter === true){

//     pokemon.splice(false , false);
//   }

// });
for (let i = 0; i < pokemon.length-1; i++) {
  if (pokemon[i].starter === true) {
    pokemon.splice([i], [i+1]);
  }
}
// console.log(pokemon)
...
*/
//................the answer or answers of 8 exersise .........................
game.party.forEach((n) => {
  // console.log(n.name);
});

// for (let n of game.party) {
// console.log(n.name);
// }
/*
............................the answer or the answers of the 9 exersise..............................
Exercise 9
...
game.partyCount = function () {
  let count = 0;
  for (let index = 0; index < game.party.length - 1; index++) {
    count = count + 1;
  }
  console.log(count);
